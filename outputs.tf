output "vantage_cross_account_connection_role_arn" {
  ...
  value       = try(var.cur_bucket_name != "" ? aws_iam_role.vantage_cross_account_connection_with_bucket[0].arn : aws_iam_role.vantage_cross_account_connection_without_bucket[0].arn)
}

output "vantage_cost_and_usage_report_arn" {
  description = "The Vantage CUR arn"
  value       = try(aws_cur_report_definition.vantage_cost_and_usage_reports.arn)
}
...
output "vantage_cost_and_usage_reports_bucket_arn" {
  ...
  value       = try(aws_s3_bucket.vantage_cost_and_usage_reports.arn)
}
